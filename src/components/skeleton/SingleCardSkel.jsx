export default function SingleCardSkel() {
  return (
    <div className={`border-2 border-secColor rounded-3xl p-5 bg-secColor/30 h-64 animate-pulse`}>
      <div className="flex flex-col h-full justify-between">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center space-x-2 w-full ">
            <div className="h-2.5 rounded-full bg-gray-600 w-32"></div>
            <div className="h-2.5 rounded-full bg-gray-600 w-24"></div>
            <div className="h-2.5 rounded-full bg-gray-600 w-36"></div>
          </div>
        </div>
